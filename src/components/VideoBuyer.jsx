...
const VideoBuyer = () => {
  ...
  return (
    <div className="container mx-auto gap-12 md:gap-6 px-4 md:px-12 py-12 md:py-20 bg-[#072F57] flex flex-col md:flex-row items-start md:items-center justify-evenly">
      {/* Video Section */}
