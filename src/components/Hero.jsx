...
const Hero = () => {
  return (
    <div className="bg-hero bg-cover w-full flex flex-col gap-10 items-center h-full justify-center px-4 sm:px-[0]">
      <h1 className="container mx-auto px-4  text-center font-poppins font-bold text-[#FFFFFF] text-[26px] sm:text-[40px] md:text-[55px] leading-[40px] sm:leading-[48px] md:leading-[66px]">
        Are You a Supplier?
      </h1>

      <h1 className="container mx-auto px-4 text-center font-poppins font-normal text-[#FFFFFF] text-[32px] sm:text-[40px] md:text-[55px] leading-[40px] sm:leading-[48px] md:leading-[66px]">
        Explore Matching Opportunities.
      </h1>

      {/* Form Section */}
      <form className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 px-4">
        <SearchBar
